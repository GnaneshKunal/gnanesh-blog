...
const EXPERIENCE = [
  {
    ...
    highlights: [
      ...
      "Progressed from mentoring intern cohorts to leading 2 engineering teams, driving execution and engineering standards across squads",
      ...
      "Built an AI-powered workflow harness with a multi-stage verification system, delivering high-confidence automated task execution in production",
